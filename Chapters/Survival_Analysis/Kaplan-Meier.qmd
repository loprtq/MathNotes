...
Ideally, all individuals should be followed until they experience the event or reach the end of the study period (no right-censoring or right-truncation). While the Kaplan-Meier method can handle censoring, excessive loss to follow-up can reduce precision and potentially introduce bias.
