...
If the two stochastic variables $X$ and $Y$ are independent, then their covariance is 0. However, the converse is not true - if the covariance between two stochastic variables is 0, then they are not necessarily independent.
