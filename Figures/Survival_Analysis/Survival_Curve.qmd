...
#| echo: false
#| warning: false
#| fig-cap: Survival curve for patients with advanced lung cancer at different institutes.
# Packages
library(dplyr)
library(broom)
library(ggplot2)
...
## Graph
surv_data |>
  ggplot2::ggplot(ggplot2::aes(x = TIME, y = SURV, color = SEX, group = SEX, fill = SEX)) +
